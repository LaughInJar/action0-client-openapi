...
def generate_package(api: Api, *, client_name: str, schema_name: str) -> dict[str, str]:
    """
    ...
    return {
        "__init__.py": render_init(api, header, client_name),
        "models.py": render_models(api, header),
        "operations.py": render_operations(api, header),
